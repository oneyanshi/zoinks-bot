...
public class ZoinksZergBot implements BWAPIEventListener {
    ...
    public void matchFrame() {
        ...
        System.out.println("Step after drone: " + Integer.toString(step));
        if (0<step && step<2 && bwapi.getSelf().getMinerals() >=200) {
            System.out.println("This is step " + Integer.toString(step));
            buildSpawningPool();
            System.out.println("Built a spawning pool.");
            step++;
            System.out.println("This is step " + Integer.toString(step));
        }
        ...
        else if(3<step && step<7 && bwapi.getSelf().getMinerals() >= 50) {
            spawnZerglings();
            step++;
        }
